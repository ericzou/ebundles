...
module TextMate
  class <<self
    ...
    def refresh_project_drawer
      ...
      ## 
      # This code is OS X specific and has thus been commented out. 
      # Note: the project pane in E Text Editor is refreshed automatically and 
      # so this code is not required anyway.
      ##
